...
public class OrderServiceImpl implements IOrderService {
    ...
    public ServerResponse createOrder(Integer userId, Integer ShippingId) {
        ...
        if (shipping == null) {
            return ServerResponse.serverResponseByError("所选地址不存在，请重新选择地址");
        }
    ...
    public ServerResponse cancel(Integer userId, Long orderNo) {
        ...
        Order order = orderMapper.findOrderByOrderNoAndUserId(userId, orderNo);

        if (order == null) {
            return ServerResponse.serverResponseByError("订单不存在");
        }

        //3.判断订单状态并取消,只有处于未付款状态才能取消
        ...
        return ServerResponse.serverResponseBySuccess("取消订单成功");
    }
...
//----------------------------------支付相关------------------------------------------//
    ...
    public ServerResponse pay(Integer userId, Long orderNo) throws IOException {
        ...
        return ServerResponse.serverResponseBySuccess(serverResponse);
